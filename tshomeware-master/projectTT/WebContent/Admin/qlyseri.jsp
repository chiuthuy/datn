...
<title>Quản Lý Số Seri Sản Phẩm | Admin TH-HOMEWARE</title>
   ...
   $('#nhapseri').modal('show');
	...
	<jsp:include page="header.jsp"></jsp:include>
			...
			<div id="page-inner">
				<div class="row">
					...
					<!-- 	<div class="navbar-header">
							...
							<a class="navbar-brand" href="/TH_Homeware/Admin/seri_insert.jsp" style="color: white;">Nhập Số Seri
								</a>
						</div> -->
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/seri_insert.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Nhập Số Seri</a>
						</div>
					</div>
				</div>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										%>
											<tr class="odd gradeX">
												...
												<td class="center" style="text-align: center;">
							<a href="/TH_Homeware/Admin/seri_edit.jsp?action=Update&ID_Product=<%=listseri.get(i).getMasanpham()%>&Name_Product=<%=listseri.get(i).getTensanpham()%>&id_seri=<%=listseri.get(i).getSoseri()%>&Status_Seri=<%=listseri.get(i).getTrangthai()%>" 
													<% 
													if (listseri.get(i).getTrangthai()==1) {											
		...
		<div class="modal-dialog">
		          <form class="modal-content animate" action="/TH_Homeware/NhapSeri" method="post">
