...
<head>
<meta charset="UTF-8">
<title>Chi tiết hóa đơn | Admin TH-Homeware</title>
					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/invoice_manager.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Quay lại</a>
						</div>
