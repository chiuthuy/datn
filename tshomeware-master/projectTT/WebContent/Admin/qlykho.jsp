...
<title>Quản Lý Kho | Admin TH-Homeware</title>
<!-- BOOTSTRAP STYLES-->
					...
					<div class="col-md-12">
						...
						<!-- <div class="navbar-header">
							<button type="button" class="navbar-toggle"
								...
								<a  class="navbar-brand" href="/TH_Homeware/Admin/kho_insert.jsp" style="color: white;">Thêm Sản Phẩm Vào Kho</a>
						</div> -->
						...
						<!-- <div class="navbar-header" style="margin-left:30px">
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/product_export.jsp" style="color: white;">Sản Phẩm Đã Xuất Kho</a>
						</div> -->
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								data-toggle="collapse" data-target=".sidebar-collapse">
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/product_export.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Sản Phẩm Đã Xuất Kho</a>
						</div>
					</div>
				</div>
				<hr />
