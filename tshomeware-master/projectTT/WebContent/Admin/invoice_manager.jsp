...
<title>Quản Lý Danh Mục | Admin TH-Homeware</title>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											<tr class="odd gradeX">
												...
												<a href="/TH_Homeware/Admin/invoiceDetail_edit.jsp?action=Update&ID_InvoiceDetail=<%=invoiceDetail.getID_InvoiceDetail()%>&Quantity=<%=invoiceDetail.getQuantity()%>" class="btn btn-danger btn-xs">Sửa</a> 
												<a href="/TH_Homeware/InvoiceDetailServlet_Update_Del?action=Delete&ID_InvoiceDetail=<%=invoiceDetail.getID_InvoiceDetail() %>" onclick="return confirm('Bạn chắc chắn chứ ?')" class="btn btn-warning btn-xs">Xóa</a>
												</td>
											</tr>
										</tbody>
										<%
									...
									<table class="table table-striped table-bordered table-hover"
										...
										%>
											<tr class="odd gradeX">
												...
												<td class="center" style="text-align: center;">
													<a href="/TH_Homeware/Admin/invoice_edit.jsp?action=Update&ID_Invoice=<%=invoice.getID_Invoice()%>&Shipping_Address=<%=invoice.getShipping_Address() %>&Status_Order=<%=invoice.getStatus_Order() %>"
													<% 
												...
												<%-- <a href="/TH_Homeware/InvoiceServlet_Update_Del?action=Delete&ID_Invoice=<%=invoice.getID_Invoice() %> " onclick="return confirm('Bạn không thể xóa dòng này nếu mà bạn chưa xóa dòng tương ứng với hóa đơn chi tiết ?')"
													class="btn btn-warning btn-xs">Xóa</a></td> --%>
													<td class="center" style="text-align: center;">
												
												<a href="/TH_Homeware/InvoiceHistoryDetailAdmin?action=Views&ID_Invoice=<%=invoice.getID_Invoice()%>"
