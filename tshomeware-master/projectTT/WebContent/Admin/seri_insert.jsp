...
<title>Quản Lý Số Seri| Admin TH-Homeware</title>
					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-6">
										<form role="form" action="/TH_Homeware/NhapSeri" method="post">
						...
						<select class="form-control" name = "Masp" id="cmbTenSP" >
											...
											<a href="/TH_Homeware/Admin/qlyseri.jsp"  class="btn btn-danger" style="margin-left:5%">Thoát</a>	
										</form>
										<br />
									</div>
								</div>
