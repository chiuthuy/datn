...
<head>
<meta charset="UTF-8">
<title>Chi Tiết Khuyến Mãi | Admin TH-Homeware</title>
					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="btn btn-success" href="/TH_Homeware/Admin/promotion_manager.jsp" style="font-size:14px;padding:8px 12px"> QUAY LẠI</a>
						</div>
