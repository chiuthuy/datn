...
<head>
<meta charset="UTF-8">
<title>Chi tiết phiếu nhập | Admin TH-Homeware</title>
...
<!-- <link href="/TH_Homeware/Admin/assets/css/custom.css" rel="stylesheet" />  -->
 <link href='http://fonts.googleapis.com/css?family=Open+Sans'
	...
	<link rel="stylesheet" href="/TH_Homeware/css/normalize.min.css">
	<!-- <style type='text/css'>
        .a {
            background: black;
            color: white;
       ...
       <!--  <script src="/TH_Homeware/js/html5-3.6-respond-1.1.0.min.js"></script> -->
...
<div id="wrapper">
		...
		<div id="page-wrapper">
					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="btn btn-success" href="/TH_Homeware/Admin/GoodReceipt.jsp" style="font-size:14px;padding:8px 12px"> PHIẾU NHẬP</a>
						</div>
		 ...
		 data-id=<%=idgoodReceiptString %> class="btn btn-success" href="/TH_Homeware/Admin/NewReceipt.jsp?ID_Receipt=<%=goodReceipt.getID_Receipt()%>" style="font-size:14px;padding:8px 12px"> NHẬP THÊM </a>
						</div>
						<div class="btn btn-success" style="padding: 0px 0px;margin-left:20px" >
							<button type="button" class="navbar-toggle"
								data-toggle="collapse" data-target=".sidebar-collapse">
								...
								<a <%if(dateCurrent.compareTo(dateGoodReceipt)>0 ){ %> style="display:none"
		 <% }else if (!acc.getID_Account().equals(goodReceipt.getID_Account())){ %> style="pointer-events: none; background:#DDDDDD;color:black;font-size:14px;padding:8px 12px"<%}else{ %>style=" display:block;pointer-events: auto;font-size:14px;padding:8px 12px"<%}  %>
		 data-id=<%=idgoodReceiptString %> class="btn btn-success" href="/TH_Homeware/Admin/AddNewReceipt.jsp?ID_Receipt=<%=goodReceipt.getID_Receipt()%>" style="font-size:14px;padding:8px 12px"> NHẬP MỚI </a>
						</div>
	...
	<script src="assets/js/dataTables/dataTables.bootstrap.js"></script> 
	 ...
	 <!-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script> -->
        <script>
        window.jQuery || document.write('<script src="/TH_Homeware/dist/jquery.min.js"><\/script>')
        </script>
       
        <script src="/TH_Homeware/js/jQuery.print.js"></script>
