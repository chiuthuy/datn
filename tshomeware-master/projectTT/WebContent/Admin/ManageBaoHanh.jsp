...
<title>Quản Lý Bảo Hành | Admin TH-HOMEWARE</title>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<!-- <div class="navbar-header">
							...
							<a class="navbar-brand" href="/TH_Homeware/Admin/ThemBaoHanh.jsp" 
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/ThemBaoHanh.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Thêm bảo hành</a>
						</div>
					</div>
				</div>
									...
									<table class="table table-striped table-bordered table-hover"
										...
										<tbody>
											...
											<tr class="odd gradeX">
												...
												<td class="center" style="text-align: center;">
													<a href="/TH_Homeware/Admin/SuaBaoHanh.jsp?ID_Warranty=<%=listBH.get(i).getId()%>&Status=<%=listBH.get(i).getTrangthai()%>"
													<% 
													if (listBH.get(i).getTrangthai() == 4) {											
