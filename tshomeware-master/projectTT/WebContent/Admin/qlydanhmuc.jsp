					...
					<div class="col-md-12">
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/category_insert.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Thêm danh mục</a>
						</div>
					</div>
				</div>
				<hr />
										...
										<%
											...
											<tr class="odd gradeX">
												...
												<!-- <td>GD</td> -->
												 ...
												 <span><a href="/TH_Homeware/Admin/category_edit.jsp?action=Update&ID_Category=<%=cate.getID_Category()%>&Name_Category=<%=cate.getName_Category()%>"
