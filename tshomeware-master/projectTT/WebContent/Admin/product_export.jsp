...
<title>Xuất Kho | Admin TH-Homeware</title>
					...
					<div class="col-md-12">
						...
						<!-- <div class="navbar-header">
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/qlykho.jsp" style="color: white;"> QUAY LẠI</a>
						...
						<div class="btn btn-success" style="padding: 0px 0px;" >
							<button type="button" class="navbar-toggle"
								...
								<a class="navbar-brand" href="/TH_Homeware/Admin/qlykho.jsp" style="color: white;text-transform:uppercase;font-size:14px;"> Quay lại</a>
						</div>
