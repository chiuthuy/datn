...
<title>Liên Hệ | TH-Homeware</title>
				...
				<div class="col-sm-4">
					<div class="contact-info">
						...
						<address>
							...
							<p>Mobile: +0379 185 807</p>
							<p>Email: chiuvanthuy98@gmail.com</p>
						</address>
						<div class="social-networks">
							<h2 class="title text-center">MẠNG XÃ HỘI</h2>
							<ul>
								<li><a target="_blank" href="https://www.facebook.com/chiu.thuy.2708"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://myaccount.google.com/?utm_source=OGB&tab=wk&utm_medium=act"><i class="fa fa-google-plus"></i></a></li>
								<li><a target="_blank" href="https://www.youtube.com/channel/UCwxXPrZjvni71ahXBHquW9w/featured"><i class="fa fa-youtube"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
