   ...
   <script>
	$(document).ready(function(){
		$("#btnSearch").click(function(){
			...
			$.ajax({
				type: "post",
				url: "/TH_Homeware/searchServlet",
				data: {
					textSearch : textSearch
				},
				success : function(response){
					
						window.location.href="http://localhost:8080/TH_Homeware/index10.jsp"
				...
				<div class="col-sm-6">
					<div class="contactinfo">
						<ul class="nav nav-pills">
							<li><a href="#"><i class="fa fa-phone"></i> +0379 185807</a></li>
							<li><a href="#"><i class="fa fa-envelope"></i>
									chiuvanthuy98@gmail.com</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-6">
					<div class="social-icons pull-right">
						<ul class="nav navbar-nav">
							<li><a target="_blank" href="https://www.facebook.com/chiu.thuy.2708" title="Facebook"><i
									class="fa fa-facebook"></i></a></li>
							<li><a target="_blank" href="https://www.youtube.com/channel/UCwxXPrZjvni71ahXBHquW9w/featured" title="Youtube"><i 
					...
					<div class="shop-menu pull-right">
						<ul class="nav navbar-nav">
							...
							<li><a <%if(user!=null){%> style="display:block " <%}
									...
									<li><a 
										href="/TH_Homeware/profile.jsp">Thông tin tài khoản</a></li>
										<li><a 
										href="/TH_Homeware/invoiceDetail.jsp">Xem chi tiết đơn hàng</a></li>
										<li><a 
										href="/TH_Homeware/invoiceHistory.jsp">Xem lịch sử đơn hàng</a></li>
										<li>
		                            	<a href="/TH_Homeware/CheckBH.jsp">Bảo hành sản phẩm</a> 
	                        		</li>
										<li><a 
